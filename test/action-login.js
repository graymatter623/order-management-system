...
} = require("./utility/db-services");
describe("Test for the action login on the / route", () => {
  let driver;
  before(async () => {
    driver = await buildDriver();
  });
  it("correctly login", async () => {
    await login(driver, Credentials.admin);
  ...
  it("Correctly checked the username on profile menu card ", async () => {
    ...
    await driver.wait(
      until.elementTextIs(
        driver.findElement(By.id("profile-card-employee-username-id")),
        Credentials.admin.employee_username
      ),
      2000
    );
    await driver
      .findElement(By.id("profile-card-employee-username-id"))
      .click();
  ...
  it("correctly search employee ", async () => {
    ...
    await driver.wait(
      until.elementTextIs(
        driver.findElement(By.id("employee-name-link-id-0")),
        "Shubham carpenter"
      ),
      2000
    );
  ...
  it("correctly edit employee ", async () => {
    ...
    await driver
      ...
      .sendKeys(Credentials.at04.employee_name);
    await driver.wait(
      until.elementsLocated(By.id("employee-name-link-id-0")),
      2000
    );
    await driver.wait(
      until.elementTextIs(
        driver.findElement(By.id("employee-name-link-id-0")),
        Credentials.at04.employee_name
      ),
      2000
    );
    await driver.sleep(1000);
    ...
    await driver
      ...
      .sendKeys(Credentials.at04.employee_name + " new name");
    await driver.sleep(1000);
    ...
    await driver.sleep(1000);
    await updateEmployeeName(Credentials.at04);
    await navToDashBoard(driver);
  });
